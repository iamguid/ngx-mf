...
describe('Test different form definition syntax', () => {
    ...
    describe('Nested FormGroup', () => {
        it('constructor syntax', () => {
            const form: FormGroup<FormControlsOf<NestedModel, { a: 'group' }>> = new FormGroup({
                a: new FormGroup({
        ...
        it('FormBuilder syntax', () => {
            ...
            const form: FormGroup<FormControlsOf<NestedModel, { a: 'group' }>> = fb.group({
                a: fb.group({
                    b: fb.control(42)
                })
            })
    ...
    describe('Nested FormArray', () => {
        it('constructor syntax', () => {
            const form: FormGroup<FormControlsOf<ArrayModel, { a: 'array' }>> = new FormGroup({
                a: new FormArray([
                    new FormControl(42)
                ])
            })
        ...
        it('FormBuilder syntax', () => {
            ...
            const form: FormGroup<FormControlsOf<ArrayModel, { a: 'array' }>> = fb.group({
                a: fb.array([
                    fb.control(42)
                ])
            })
