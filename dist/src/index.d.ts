...
declare type FormControlsOfInnerTraverse<TModel extends object | unknown, TTraverseModel extends object | unknown, TInferMode extends InferMode, TAnnotations extends object | string | null> = TAnnotations extends null ? TTraverseModel extends Array<any> ? FormControlsOfInnerTraverse<TModel, TTraverseModel, TInferMode, 'array'> : TTraverseModel extends object ? FormControlsOfInnerTraverse<TModel, TTraverseModel, TInferMode, 'group'> : FormControlUtil<TModel extends unknown ? TTraverseModel : TModel, TInferMode> : TAnnotations extends Replace<infer TInferredReplace> ? TInferredReplace : TAnnotations extends 'array' ? TTraverseModel extends Array<any> ? FormArrayUtil<TModel, TInferMode> : never : TAnnotations extends 'group' ? TTraverseModel extends object ? FormGroup<FormControlsOfInnerKeyofTraverse<NonNullable<TModel>, TTraverseModel, TInferMode, null>> : never : TAnnotations extends 'control' ? FormControlUtil<TModel extends unknown ? TTraverseModel : TModel, TInferMode> : TAnnotations extends Array<infer TInferedAnnotations> ? TTraverseModel extends Array<infer TInferedArrayType> ? FormArray<FormControlsOfInnerTraverse<TModel extends Array<infer U> ? U : unknown, TInferedArrayType, TInferMode, TInferedAnnotations>> : never : TAnnotations extends object ? TTraverseModel extends object ? FormGroup<FormControlsOfInnerKeyofTraverse<NonNullable<TModel>, TTraverseModel, TInferMode, TAnnotations>> : never : TAnnotations extends unknown ? FormControlUtil<TModel extends unknown ? TTraverseModel : TModel, TInferMode> : never;
export {};
